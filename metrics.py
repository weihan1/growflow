...
def convert_to_csv(results, output_path):
    """
    ...
    #TODO: save these individual ones as arrays!
    for method in results:
        for metric in ['psnr', 'ssim', 'lpips', 'chamfer']:
            if metric not in results[method]:
                continue
    ...
    for test_folder in method_paths:
        ...
        for camera_folder in camera_folders:
            ...
            for i, img_file in enumerate(img_files):
                ...
                results[method_name]["psnr"][camera_folder][timestep] = round(psnr(rendered_img, eval_pixels).item(), 2)
        ...
        if point_cloud_trajectory_filename in os.listdir(test_folder):
            ...
            for t, mesh_index in enumerate(mesh_indices):
                ...
                chamfer_distance, unscaled_gt_mesh_vert = (
...
if __name__ == "__main__":
    ...
    #NOTE: 
    # The order of renderings is always gt, upper_bound, Dynamic3DGS, 4dgs, 4dgaussians, ours
    #TODO: change these
    gt_data_dir = {
        "rose_transparent_final_small_vase": "./data/dynamic/blender/360/multi-view/31_views/rose_transparent_final_small_vase",
        "rose_transparent_final_small_vase_70_timesteps": "./data/dynamic/blender/360/multi-view/31_views/rose_transparent_final_small_vase_70_timesteps",
        "lily_transparent_final_small_vase": "./data/dynamic/blender/360/multi-view/31_views/lily_transparent_final_small_vase",
        "lily_transparent_final_small_vase_70_timesteps": "./data/dynamic/blender/360/multi-view/31_views/lily_transparent_final_small_vase_70_timesteps",
        "tulip_transparent_final_small_vase": "./data/dynamic/blender/360/multi-view/31_views/tulip_transparent_final_small_vase",
        "tulip_transparent_final_small_vase_70_timesteps": "./data/dynamic/blender/360/multi-view/31_views/tulip_transparent_final_small_vase_70_timesteps",
        "clematis_transparent_final_small_vase": "./data/dynamic/blender/360/multi-view/31_views/clematis_transparent_final_small_vase",
        "clematis_transparent_final_small_vase_70_timesteps": "./data/dynamic/blender/360/multi-view/31_views/clematis_transparent_final_small_vase_70_timesteps",
        "peony_transparent_final_small_vase_70_timesteps": "./data/dynamic/blender/360/multi-view/31_views/peony_transparent_final_small_vase_70_timesteps",
        "plant_1_transparent_final_small_vase_70_timesteps": "./data/dynamic/blender/360/multi-view/31_views/plant_1_transparent_final_small_vase_70_timesteps",
        "plant_2_transparent_final_small_vase_70_timesteps": "./data/dynamic/blender/360/multi-view/31_views/plant_2_transparent_final_small_vase_70_timesteps",
        "plant_3_transparent_final_small_vase_70_timesteps": "./data/dynamic/blender/360/multi-view/31_views/plant_3_transparent_final_small_vase_70_timesteps",
        "plant_4_transparent_final_small_vase_70_timesteps": "./data/dynamic/blender/360/multi-view/31_views/plant_4_transparent_final_small_vase_70_timesteps",
        "plant_5_transparent_final_small_vase_70_timesteps": "./data/dynamic/blender/360/multi-view/31_views/plant_5_transparent_final_small_vase_70_timesteps"
    }

    our_test_folders = {
        "rose_transparent_final_small_vase_70_timesteps": "/scratch/ondemand28/weihanluo/neural_ode_splatting/results/rose_transparent_final_small_vase_70_timesteps/final/full_eval/test",
        "lily_transparent_final_small_vase_70_timesteps": "/scratch/ondemand28/weihanluo/neural_ode_splatting/results/lily_transparent_final_small_vase_70_timesteps/final/full_eval/test",
        "tulip_transparent_final_small_vase_70_timesteps": "/scratch/ondemand28/weihanluo/neural_ode_splatting/results/tulip_transparent_final_small_vase_70_timesteps/final/full_eval/test",
        "clematis_transparent_final_small_vase_70_timesteps": "/scratch/ondemand28/weihanluo/neural_ode_splatting/results/clematis_transparent_final_small_vase_70_timesteps/final/full_eval/test",
        "peony_transparent_final_small_vase_70_timesteps": "/scratch/ondemand28/weihanluo/neural_ode_splatting/results/peony_transparent_final_small_vase_70_timesteps/baseline_short_int/full_eval/test",
        "plant_1_transparent_final_small_vase_70_timesteps": "/scratch/ondemand28/weihanluo/neural_ode_splatting/results/plant_1_transparent_final_small_vase_70_timesteps/final/full_eval/test",
        "plant_2_transparent_final_small_vase_70_timesteps": "/scratch/ondemand28/weihanluo/neural_ode_splatting/results/plant_2_transparent_final_small_vase_70_timesteps/final/full_eval/test",
        "plant_3_transparent_final_small_vase_70_timesteps": "/scratch/ondemand28/weihanluo/neural_ode_splatting/results/plant_3_transparent_final_small_vase_70_timesteps/final/full_eval/test",
        "plant_4_transparent_final_small_vase_70_timesteps": "/scratch/ondemand28/weihanluo/neural_ode_splatting/results/plant_4_transparent_final_small_vase_70_timesteps/final/full_eval/test",
        "plant_5_transparent_final_small_vase_70_timesteps": "/scratch/ondemand28/weihanluo/neural_ode_splatting/results/plant_5_transparent_final_small_vase_70_timesteps/final/full_eval/test"
    }

    #TODO: save the numerical results for baselines, so we don't need to compute them everytime!     

    for scene in ["lily_transparent_final_small_vase_70_timesteps",
                  "tulip_transparent_final_small_vase_70_timesteps",
                  "clematis_transparent_final_small_vase_70_timesteps",
                  "plant_1_transparent_final_small_vase_70_timesteps",
                  "plant_2_transparent_final_small_vase_70_timesteps",
                  "plant_4_transparent_final_small_vase_70_timesteps",
                  "plant_5_transparent_final_small_vase_70_timesteps"]: 

    # for scene in ["lily_transparent_final_small_vase_70_timesteps"]:
    # for scene in ["peony_transparent_final_small_vase_70_timesteps"]:
        data_dir = gt_data_dir[scene]
        print(f"getting all results for scene {scene}")
        device = torch.device("cuda:0")
        cfg = tyro.cli(Config) 
        assert cfg.task_name in ["dense_supervision", "sparse_time", "monocular"]
        method_paths = []
        ...
        if cfg.existing_result_path != "":
            ...
            results = evaluate(cfg, data_dir, method_paths, output_path=output_path, split="test")
        ...
        if scene == "clematis_transparent_final_small_vase_70_timesteps":
            center_position = [0.00545695, -0.0413458, 1.680124]
        elif scene == "lily_transparent_final_small_vase_70_timesteps":
            center_position = [-0.01201824, -0.00301804, 1.6874188]
        elif scene == "tulip_transparent_final_small_vase_70_timesteps": 
        ...
        elif scene == "plant_1_transparent_final_small_vase_70_timesteps":
            center_position = [-0.01575137, -0.00203469,  1.6202013]
        elif scene == "plant_2_transparent_final_small_vase_70_timesteps":
            center_position = [ 0.00193186, -0.00170395,  1.6401193 ]
        elif scene == "plant_3_transparent_final_small_vase_70_timesteps":
            center_position = [6.3185021e-04, 5.7011396e-03, 1.6463835e+00]
        elif scene == "plant_4_transparent_final_small_vase_70_timesteps":
        ...
        if not os.path.exists(f"{data_dir}/gt_pc.mp4"):
            animate_point_clouds_lst(
                gt_mesh_vertices_lst,
                figsize=(6, 6),
                output_file=f"{data_dir}/gt_pc.mp4",
                is_reverse=False,
        ...
        #gt video path
        video_paths = [f"{data_dir}/gt_pc.mp4"]

        #Do a collage of all point cloud trajectories across all methods.
        point_cloud_animation_filename = "point_cloud_animation.mp4"
        for method in method_paths:
            full_path = os.path.join(method, point_cloud_animation_filename)
            if os.path.exists(full_path): #the per timestep static doesnt have pc animation.
        ...
        for i in range(num_videos):
            filter_complex += f"[{i}:v]"
        filter_complex += f"hstack=inputs={num_videos}[v]"
        output_file_name = "point_cloud_traj_all.mp4"
        ffmpeg_cmd.extend(["-y", "-filter_complex", filter_complex, "-map", "[v]", f"{output_path}/point_cloud_traj_all.mp4"])
        print("Running command:", " ".join(ffmpeg_cmd))
        subprocess.run(ffmpeg_cmd)
