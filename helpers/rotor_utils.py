...
def slice_4d(scale, r1, r2):
    ...
    cov_3d_full[:, 0, 0] = cov_3d_out0  # Σ_xx
    cov_3d_full[:, 0, 1] = cov_3d_out1  # Σ_xy
    cov_3d_full[:, 0, 2] = cov_3d_out2  # Σ_xz
    cov_3d_full[:, 1, 0] = cov_3d_out1  # Σ_xy (symmetric)
    cov_3d_full[:, 1, 1] = cov_3d_out3  # Σ_yy
    cov_3d_full[:, 1, 2] = cov_3d_out4  # Σ_yz
    cov_3d_full[:, 2, 0] = cov_3d_out2  # Σ_xz (symmetric)
